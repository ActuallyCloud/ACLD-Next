...
export default function Gallery() {
    return (
        <div className="max-w-7xl p-4 mx-auto cursor-default">
            ...
            <div className="mx-auto grid grid-cols-1 place-content-evenly sm:grid-cols-2 md:grid-cols-3 gap-8 p-8">
                <div>
                    <Image src="/ux/stroogle/s1.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/stroogle/s2.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/stroogle/s3.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/stroogle/s4.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/stroogle/s5.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
            </div>
            ...
            <div className="mx-auto grid grid-cols-1 place-content-evenly justify-center md:grid-cols-2 gap-8 p-8">
                <div>
                    <Image src="/ux/wellness/w1.png" alt="wellness" width={600} height={800} className="border rounded-xl mx-auto w-full" />
                </div>
                <div>
                    <Image src="/ux/wellness/w2.png" alt="wellness" width={600} height={800} className="border rounded-xl mx-auto w-full" />
                </div>
                <div>
                    <Image src="/ux/wellness/w3.png" alt="wellness" width={600} height={800} className="border rounded-xl mx-auto w-full" />
                </div>
            </div>
            ...
            <div className="mx-auto grid grid-cols-1 place-content-evenly sm:grid-cols-2 md:grid-cols-3 gap-8 p-8">
                <div>
                    <Image src="/ux/linker/l1.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/linker/l3.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/linker/l4.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/linker/l5.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/linker/l6.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
                <div>
                    <Image src="/ux/linker/l8.png" alt="linker" width={400} height={600} className="border rounded-xl mx-auto" />
                </div>
            </div>
        </div>
    )
