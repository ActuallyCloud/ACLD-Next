      ...
      <div>
         ...
         <motion.div
            ...
            <motion.div
               ...
               <h3>Linker</h3>
               <p>I designed a draft UI interface for a new type of messaging app that alleviates the common problem of misdials and is easier to read. <a href={process.env.figma_linker} rel="noopener noreferrer" target="_blank">Try the Figma prototype here</a>.</p>
               <div className={styles.indexflexdiv}>
